  ...
  _proto.fieldError = function fieldError(errors) {
    ...
    if (errors != null) {
      er = Object.entries(errors).map(function (_ref2) {
        var err = _ref2[1];
        return /*#__PURE__*/React.createElement(Form.Text, {
    ...
    var res = Object.entries(this.state.fields.fields).map(function (_ref3) {
      ...
      if (value.type == "textarea") {
        return /*#__PURE__*/React.createElement("div", {
          key: "field-" + key
        }, /*#__PURE__*/React.createElement(Form.Group, null, /*#__PURE__*/React.createElement(Form.Label, null, value.label, " ", _this3.requiredFieldStar(value)), /*#__PURE__*/React.createElement("textarea", {
        ...
        return /*#__PURE__*/React.createElement("div", {
          key: "field-" + key
        }, /*#__PURE__*/React.createElement(Form.Group, null, /*#__PURE__*/React.createElement(Form.Label, null, value.label, " ", _this3.requiredFieldStar(value)), _this3.state.fields.fields[key]['url'] ? /*#__PURE__*/React.createElement(AsyncSelect, {
          name: key,
          ref: _this3.state.fields.fields[key]["actions"],
          placeholder: value.placeholder != null && value.placeholder,
        ...
        return /*#__PURE__*/React.createElement("div", {
          key: "field-" + key
        }, /*#__PURE__*/React.createElement(Form.Group, null, /*#__PURE__*/React.createElement(Form.File, {
          ref: _this3.state.fields.fields[key]["actions"],
          label: value.name,
          name: value.key
        }), _this3.fieldError(value.errors)));
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          ref: _this3.state.fields.fields[key]["actions"]
        }, /*#__PURE__*/React.createElement(Form.Label, null, value.label, " ", _this3.requiredFieldStar(value)), Object.entries(value.options).map(function (_ref4) {
          var v = _ref4[1];
          var ischecked = false;
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          ref: _this3.state.fields.fields[key]["actions"]
        }, /*#__PURE__*/React.createElement(Form.Label, null, value.label, " ", _this3.requiredFieldStar(value)), Object.entries(value.options).map(function (_ref5) {
          var v = _ref5[1];
          var checked = false;
        ...
        return /*#__PURE__*/React.createElement("div", {
          key: "field-" + key
        }, /*#__PURE__*/React.createElement(Form.Group, null, /*#__PURE__*/React.createElement(Form.Label, null, value.label, " ", _this3.requiredFieldStar(value)), /*#__PURE__*/React.createElement(InputGroup, null, value.prefix && /*#__PURE__*/React.createElement(InputGroup.Text, {
          id: "basic-addon1"
        }, value.prefix), /*#__PURE__*/React.createElement(Form.Control, {
          ref: _this3.state.fields.fields[key]["actions"],
          onChange: _this3.change.bind(_this3),
          readOnly: value.readOnly == true ? true : false,
          type: value.type,
          ...
          value: value.value != null ? value.value : "",
          placeholder: value.placeholder != null && value.placeholder
        }), value.suffix && /*#__PURE__*/React.createElement(InputGroup.Text, {
          id: "basic-addon1"
